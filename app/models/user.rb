...
class User < ApplicationRecord
  ...
  has_many(:recieved_follow_request, :class_name => "FollowRequest", :foreign_key => "recipient_id")
 ...
 has_many(:accepted_received_follow_requests, => {where status: "accepted"} :class_name => "FollowReqiest", :foreign_key => "recipient_id")
  ...
  has_many(:followers, :through :accepted_received_follow_requests, :source => :senders)
